...
class _MatrixDecomposition2DBase(nn.Module):
    def __init__(self, args=dict(), device=None):
        super().__init__()
        self.device = device
...
class Hamburger(nn.Module):
    def __init__(self,
        ...
        self.ham = NMF2D(ham_kwargs, device=device)
...
class LightHamHead(BaseDecodeHead):
    ...
    def __init__(self,
        ...
        self.hamburger = Hamburger(ham_channels, ham_kwargs,device=self.device, **kwargs)
